...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', '127.0.0.1,localhost,0.0.0.0,audioslash.onrender.com,*.onrender.com').split(',')
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_RENDERER_CLASSES": [
        ...
        "rest_framework.renderers.BrowsableAPIRenderer",  # Formulario web interactivo
    ],
